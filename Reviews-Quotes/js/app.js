...
function displayContent(id) {
  text.innerHTML = reviews[id].text;
  img.src = reviews[id].img;
  personName.innerHTML = reviews[id].name;
...
function displayRandomReview() {
  const randomIdx = getRandomNumber(reviews.length);
  displayContent(randomIdx);
}
/////////////////////////////////////////////
displayContent(0);
